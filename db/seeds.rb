...
create GmailMessage, from: "Bill Gates", subject: "Hello", text: "<p>I see you're follwing me on twitter. I'm honored!</p><p>Look me up if you're ever in Bellevue. We'll hang out at my pad. It's pretty sweet.</p><p>-Bill.com</p>", twitter_id: '3'
...
create Tweet, tweeter: "", tweeter_screen_name: "BillGates", text: "How do #naturalgas prices affect energy innovation? Part 1 of my chat w Daniel Yergin. Video: http://b-gat.es/IM5wj5", twitter_id: '7'
create Tweet, tweeter: "", tweeter_screen_name: "BillGates", text: "Great interest in my recent trip to Africa. We learned a lot, came back energized. Gallery from the trip: http://b-gat.es/IvdwDz", twitter_id: '8'
